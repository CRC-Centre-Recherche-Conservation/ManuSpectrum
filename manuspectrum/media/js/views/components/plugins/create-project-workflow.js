        ...
        viewModel: function(params) {
            ...
            this.stepConfig = [
                            ...
                            componentConfigs: [
                                {
                                    ...
                                    tilesManaged: 'one',
                                    parameters: {
                                        graphid: '0b9235d9-ca85-11e9-9fa2-a4d18cec433a', //87a4319d-3ca5-43f6-88cc-a7379fba67f6
                                        nodegroupid: '0b92a414-ca85-11e9-b725-a4d18cec433a', //e18cc401-7020-11ef-8753-0575b5bada34
                                        resourceid: "['set-project-name']['project-name']['projectResourceId']",
                                        // TODO ajout moi (supprimer language of statement node) hiddenNodes: ['e18cc408-7020-11ef-8753-0575b5bada34']
                                    },
                                },
                            ],
                        },
                            ...
                            componentConfigs: [
                                {
                                    ...
                                    tilesManaged: 'one', //TODO pas sur car plusieurs tiles je crois
                                    parameters: {
                                        graphid: '0b9235d9-ca85-11e9-9fa2-a4d18cec433a',
                                        nodegroupid: '0b925e3a-ca85-11e9-a308-a4d18cec433a', //543d0b52-7023-11ef-8753-0575b5bada34
                                        resourceid: "['set-project-name']['project-name']['projectResourceId']",
                            ...
                            componentConfigs: [
                                {
                                    ...
                                    parameters: {
                                        graphid: '0b9235d9-ca85-11e9-9fa2-a4d18cec433a',
                                        nodegroupid: 'dbaa2022-9ae7-11ea-ab62-dca90488358a', //e18cc408-7020-11ef-8753-0575b5bada34
                                        resourceid: "['set-project-name']['project-name']['projectResourceId']",
                                    },
                                },
                            ],
                ...
                },
                {
                    ...
                    required: true,
                    workflowstepclass: 'create-project-add-things-step', // a supprimer
                    layoutSections: [
                        {
                            componentConfigs: [
                                {
                                    ...
                                    tilesManaged: 'one',
                                    parameters: {
                                        graphid: '1b210ef3-b25c-11e9-a037-a4d18cec433a', //Collection graph     //TODO 0b9235d9-ca85-11e9-9fa2-a4d18cec433a
                                        nodegroupid: '466f81d4-c451-11e9-b7c9-a4d18cec433a', //Curation in Collection   //TODO a8fb3c9e-bbc4-11ef-bd5f-ed806b645d76 -> ca correspond à studied objet
                                        nodeid: '466fa421-c451-11e9-9a6d-a4d18cec433a', //Curation_used in Collection (physical thing) // TODO peut etre truc en haut car il a pas de sous noedu
                                        resourceid: "['set-project-name']['project-name']['projectResourceId']",
                                        projectStepData: "['set-project-name']['project-name']" // Je sais pas
                                    },
                                },
                            ],
                        },
                            ...
                            componentConfigs: [
                                {
                                    ...
                                    parameters: {
                                        resourceid: "['set-project-name']['project-name']['projectResourceId']",
                                        collectionResourceId: "['object-search-step']['add-phys-things'][0]['collectionResourceId']", // supprimer car pas de collections
                                    },
                                },
                            ],
                        },
